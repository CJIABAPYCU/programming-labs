...
/**
 * Читает поля {@link Organization} из консоли или скрипта.
 */
public class OrganizationReader {
    ...
    /**
     * Читает организацию без автоматически генерируемых полей.
     *
     * @return черновик организации
     * @throws InputAbortException если ввод неожиданно закончился
     */
    ...
    /**
     * Читает организацию для обновления. Идентификатор назначается на сервере.
     *
     * @param id переданный id, который здесь не используется
     * @return черновик организации
     * @throws InputAbortException если ввод неожиданно закончился
     */
